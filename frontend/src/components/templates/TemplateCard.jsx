...
//       {/* CONTENT */}
//       <div className="p-5">
//         <div className="bg-[#DCF8C6] rounded-2xl p-5 min-h-[150px]">
...
//             onEdit?.(template)
//           }
//           className="flex flex-col items-center gap-1 text-[#25D366] hover:text-[#128C7E] transition"
//         >
//           <SquarePen size={22} />
//           <span className="text-sm">
//             Edit
...
//             onSend?.(template)
//           }
//           className="flex flex-col items-center gap-1 text-[#128C7E] hover:text-green-700 transition"
//         >
//           <Send size={22} />
//           <span className="text-sm">
//             Send
