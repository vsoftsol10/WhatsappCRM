...
//                 className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 outline-none focus:border-[#25D366]"
//               >
...
//                 see on WhatsApp before the campaign is saved/re-sent. */}
//             <div>
//               <label className="block mb-2 font-medium text-gray-700">
//                 Preview
//               </label>
...
const removeImage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      templateParams.length !== requiredParamCount
    ) {
      toast.error(
        `This Meta template needs exactly ${requiredParamCount} parameter${
