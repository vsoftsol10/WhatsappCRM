...
// ================= GET ALL LEADS =================
// includeLost=true so leads marked as Lost are fetched too — the Leads
// page filters them out of the default "ALL" view, but they're still
// available for the "Lost" status filter.
export const getLeads = async () => {
  const response = await apiClient.get("/api/leads?includeLost=true");
