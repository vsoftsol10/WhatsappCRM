...
export const createCampaign = async (campaignData) => {
  ...
  if (campaignData.metaTemplateName) {
...
export const updateCampaign = async (
  ...
  if (campaignData.metaTemplateName !== undefined) {
    formData.append(
      "metaTemplateName",
...
// failure reason.)
// ===============================
export const getCampaignRecipientStatuses = async (campaignId) => {
  const response = await apiClient.get(
    `/api/campaigns/${campaignId}/recipient-statuses`
  );
