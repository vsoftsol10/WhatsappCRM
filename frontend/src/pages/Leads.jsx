  ...
  const filteredLeads = useMemo(() => {
    if (selectedStatus === "ALL") {
      return searchedLeads.filter(
        (lead) => !lead.isConverted && lead.status !== "LOST"
      );
    }
...
const confirmDelete = async () => {
  ...
  return (
      ...
      <ConfirmModal
        ...
        message="This will mark the lead as lost and remove it from the active list. Its history and work notes are kept, and it won't be treated as an active lead if this number messages in again."
